...
export const boundaryTemplates = [
  {
    id: "workflow-start",
    name: "Start",
    nodeKind: "start",
    description: "Defines where workflow execution begins.",
    accent: "#10b981",
    tint: "rgba(209, 250, 229, 0.92)",
    border: "#6ee7b7",
  },
  {
    id: "workflow-end",
    name: "End",
    nodeKind: "end",
    description: "Defines where workflow execution finishes.",
    accent: "#f43f5e",
    tint: "rgba(255, 228, 230, 0.92)",
    border: "#fda4af",
  },
];
